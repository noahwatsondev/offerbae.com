    ...
    function renderResults(data) {
        ...
        if (brands.length > 0) {
            ...
            brands.forEach(brand => {
                html += `
                    <a href="/layout/brands/${brand.slug}" class="search-result-item">
        ...
        if (products.length > 0) {
            ...
            products.forEach(product => {
                html += `
                    <a href="/layout/products/${product.slug}" class="search-result-item">
                        <div class="result-icon-wrapper">
        ...
        if (offers.length > 0) {
            ...
            offers.forEach(offer => {
                html += `
                    <a href="/layout/offers/${offer.id}" class="search-result-item">
                        <div class="result-icon-wrapper">
