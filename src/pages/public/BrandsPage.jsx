...
const BrandsPage = () => {
  ...
  return (
    <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg my-8">
      <h1 className="text-4xl font-extrabold text-center text-gray-800 mb-6">Brands (Public)</h1>
      <p className="text-center text-lg text-gray-600 mb-8">
        This page demonstrates the successful integration with the Rakuten and Commission Junction (CJ) APIs.
      </p>
